...
public class LegacyTrakEM2ImageLoader extends AbstractLegacyViewerImgLoader< ARGBType, VolatileARGBType >
{
	private Project project;
	private Loader trakemLoader;
	...
	private final TrakEM2VolatileIntArrayLoader loader;

	public class TrakEM2ImageLoader extends LegacyViewerImgLoaderWrapper< ARGBType, VolatileARGBType, LegacyTrakEM2ImageLoader >
	{
		public TrakEM2ImageLoader()
		{
			super( new LegacyTrakEM2ImageLoader( ) );
		}
	}
	...
	public void init( final Project project, final int tileWidth, final int tileHeight, final int numScales )
	{
		...
		trakemLoader = project.getLoader();
		...
		loader = new TrakEM2VolatileIntArrayLoader( trakemLoader, layerset, zScales );
	}
